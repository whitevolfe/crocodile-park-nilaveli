...
===================================================== */}
        ...
        >
          {/* Google Rating */}
          <div className="flex min-h-[72px] items-center justify-center gap-2.5 rounded-xl border border-white/10 bg-black/20 px-3 py-3 backdrop-blur-md transition-all duration-300 hover:border-white/20 hover:bg-black/30">
            <img
          ...
          <div className="flex min-h-[72px] items-center justify-center gap-2 rounded-xl border border-white/10 bg-black/20 px-3 py-3 backdrop-blur-md transition-all duration-300 hover:border-white/20 hover:bg-black/30">
            <ShieldCheck
              size={26}
              strokeWidth={2}
              className="shrink-0 text-sky-300 sm:h-7 sm:w-7"
            />
          ...
          <div className="flex min-h-[72px] items-center justify-center gap-2 rounded-xl border border-white/10 bg-black/20 px-3 py-3 backdrop-blur-md transition-all duration-300 hover:border-white/20 hover:bg-black/30">
            ...
            <svg
              viewBox="0 0 24 24"
              className="h-8 w-8 shrink-0 fill-white sm:h-9 sm:w-9"
              aria-hidden="true"
            >
          ...
          <div className="flex min-h-[72px] items-center justify-center gap-2 rounded-xl border border-white/10 bg-black/20 px-3 py-3 backdrop-blur-md transition-all duration-300 hover:border-white/20 hover:bg-black/30">
            <BadgeDollarSign
              size={26}
              strokeWidth={2}
              className="shrink-0 text-emerald-300 sm:h-7 sm:w-7"
            />
