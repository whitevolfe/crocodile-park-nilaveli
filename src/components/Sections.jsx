...
function AnimatedStat({ target, suffix = "" }) {
  ...
  return (
    <span ref={ref} className="text-3xl font-display text-primary sm:text-4xl">
    ...
    <section id="intro" className="relative py-16 sm:py-24">
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-6">
        ...
        <div className="mx-auto grid w-full max-w-7xl gap-8 lg:grid-cols-2 lg:gap-10">
              ...
              <div className="relative overflow-hidden rounded-3xl border border-primary/20 shadow-[var(--shadow-lux)]">
                ...
                <div className="absolute right-0 bottom-0 left-0 p-6 sm:p-8">
                  ...
                  <p className="mt-2 max-w-md text-sm leading-relaxed text-white/80">
                    Humans can't control the nature.
                  </p>
                </div>
              </div>

              {/* 02 + 03 — Countries & Customers */}
              <div className="grid grid-cols-2 gap-4">
                {/* 02 — Countries */}
                <div className="relative min-w-0 overflow-hidden rounded-2xl border border-primary/15 bg-navy/40 p-5">
                  <span className="block text-3xl font-display text-primary sm:text-4xl">
                    <AnimatedStat target={60} suffix="+" />
                  </span>
                  ...
                  <div className="relative mt-4 w-full overflow-hidden">
                    <div className="flex w-max gap-2 animate-[flagScroll_18s_linear_infinite]">
                      {[...countryFlags, ...countryFlags].map((flag, index) => (
                        <span
                          key={index}
                          className="flex h-7 w-9 shrink-0 overflow-hidden rounded-md bg-white/10 shadow-sm"
                        >
                          <img
                            src={flag}
                            alt=""
                ...
                <div className="relative min-w-0 overflow-hidden rounded-2xl border border-primary/15 bg-navy/40 p-5">
                  <span className="block text-3xl font-display text-primary sm:text-4xl">
                    <AnimatedStat target={10000} suffix="+" />
                  </span>
          ...
          <Reveal delay={120}>
            <div className="mx-auto flex h-full w-full max-w-[600px] flex-col gap-6">
              {/* 03 — Google Rating */}
              ...
              <div className="relative mx-auto flex w-full flex-1 flex-col justify-center overflow-visible rounded-3xl border border-primary/15 bg-primary p-6 text-black sm:p-8">
                ...
                {/* FREE + ARROW + ASK ANYTHING */}
                <div className="relative mt-5 grid grid-cols-[1fr_auto_1fr] items-center gap-2 sm:gap-4">
                  {/* FREE */}
                  <div className="flex justify-start">
                    <span className="inline-flex shrink-0 rounded-full bg-black px-5 py-2 text-sm font-bold text-white">
                      FREE
                    </span>
                  </div>
                  ...
                  >
                    <svg
                      viewBox="0 0 180 40"
                      className="h-10 w-20 sm:w-36"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      {/* Arrow line */}
                      <path d="M4 20H150" stroke="black" strokeWidth="4" strokeLinecap="round" />

                      {/* Arrow head */}
                      <path
                        d="M130 6L150 20L130 34"
                        stroke="black"
                        strokeWidth="4"
                        strokeLinecap="round"
                  ...
                  <div className="flex justify-end">
                    <a
                      href={waLink(
                        `Hello ${business.name}, I would like to ask something about your tours and travel services.`,
                      )}
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Ask anything on WhatsApp"
                      className="
                        group
                        relative
                        z-10
                    ...
                    >
                      ...
                      <span className="relative flex flex-col items-center leading-tight">
                        <span className="font-display text-white">Ask anything</span>
                      </span>
                    </a>
                  </div>
                </div>
